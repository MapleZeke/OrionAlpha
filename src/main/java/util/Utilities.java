...
public class Utilities {
  ...
  /**
   * Converts an IP from a string to an integer. e.g "127.0.0.1" -> 16777343
   *
  ...
  /**
   * Converts an IP from an integer representation into a string. e.g 16777343 -> "127.0.0.1"
   *
