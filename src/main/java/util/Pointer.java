...
/**
 * A C++ Pointer class representing a Java Pointer. int* pData -> Pointer<Integer> pData
 *
 * @author Eric
...
public class Pointer<P> {
  ...
  /**
   * Returns the value of the typeof Object
   *
   * <p>
   *
   ...
   * If the Pointer
   *
   * <p>instances type of Number, this will add to the current value <code>nVal</code>.
   *
   ...
   * If the Pointer
   *
   * <p>instances type of Number, this will subtract <code>nVal</code> from the current value.
   *
  ...
  /**
   * Determines if the value is set. This returns true under two conditions: a) The pointer is an
   * Integer, and the value != 0, or b) The pointer is a Boolean, and the value == true.
   *
  ...
  /**
   * Turns the current Pointer
   *
   * <p>instance into a string.
   *
   * @return
   */
  @Override
