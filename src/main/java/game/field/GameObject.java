 ...
 * CGameObject
 *
 * <p>While this class is actually very much a real, abstract class, Java cannot extend and inherit
 * from multiple classes. For this reason, we hold this as an interface and control it from a Base.
 *
 * <p>Nexon registers and unregisters these objects in addition to assigning each a dwID
 * (GameObjectID), thus we do so in the Base.
 *
 * <p>All classes used to inherit from GameObject will return the said GameObjectID in their
 * inherited GetGameObjectID() methods.
 *
 * @author Eric
 */
