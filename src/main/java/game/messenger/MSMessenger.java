  ...
  public static void onInvite(User user, String targetName) {
    if (user.getMessenger().getMSM() != null) {
      ...
      if (target != null) {
        ...
        target.sendPacket(
            Messenger.onInvite(user.getCharacterName(), user.getMessenger().getMSM().getSN()));
      } else {
              ...
              if (idx != i) {
                character
                    ...
                    .sendPacket(
                        Messenger.onAvatar(
                            (byte) idx,
                            c.getUser().getCharacter().getCharacterStat().getGender(),
                            c.getUser().getCharacter().getCharacterStat().getFace(),
                            c.getAvatarLook()));
              }
            }
          }
          ...
          if (character.get(i).getUser() != null) {
            if (i != emptyIdx) {
              ...
              user.sendPacket(
                  Messenger.onEnter(
                      (byte) i,
                      character.get(i).getUser().getCharacter().getCharacterStat().getGender(),
                      character.get(i).getUser().getCharacter().getCharacterStat().getFace(),
                      character.get(i).getAvatarLook(),
                  ...
                  .sendPacket(
                      Messenger.onEnter(
                          ...
                          character
                              ...
                              .getCharacterStat()
                              .getFace(),
                          character.get(emptyIdx).getAvatarLook(),
                          character.get(emptyIdx).getID(),
                          false));
            }
          }
        }
