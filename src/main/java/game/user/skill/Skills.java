...
public class Skills {
  ...
  public static class Warrior extends Skills {
    ...
    public static final int ImproveBasic = 1000000,
        MHPInc = 1000001,
        Endure = 1000002,
        IronBody = 1001003,
        PowerStrike = 1001004,
  ...
  public static class Fighter extends Skills {
    ...
    public static final int WeaponMastery = 1100000,
  ...
  public static class Spearman extends Skills {
    ...
    public static final int WeaponMastery = 1300000,
  ...
  public static class Magician extends Skills {
    ...
    public static final int ImproveBasic = 2000000,
        MMPInc = 2000001,
        MagicGuard = 2001002,
        MagicArmor = 2001003,
        EnergyBolt = 2001004,
  ...
  public static class Wizard1 extends Skills {
    ...
    public static final int MPEater = 2100000,
  ...
  public static class Wizard2 extends Skills {
    ...
    public static final int MPEater = 2200000,
  ...
  public static class Cleric extends Skills {
    ...
    public static final int MPEater = 2300000,
  ...
  public static class Archer extends Skills {
    ...
    public static final int AmazonBlessing = 3000000,
  ...
  public static class Hunter extends Skills {
    ...
    public static final int BowMastery = 3100000,
  ...
  public static class Crossbowman extends Skills {
    ...
    public static final int CrossbowMastery = 3200000,
  ...
  public static class Rogue extends Skills {
    ...
    public static final int NimbleBody = 4000000,
        KeenEyes = 4000001,
        Disorder = 4001002,
        DarkSight = 4001003,
  ...
  public static class Assassin extends Skills {
    ...
    public static final int JavelinMastery = 4100000,
  ...
  public static class Thief extends Skills {
    ...
    public static final int DaggerMastery = 4200000,
        Endure = 4200001,
  ...
  public static class EricClass extends Skills {
    ...
    public static final int Retreat = 40001001,
        Jump = 40001002,
        Camouflage = 40001003,
