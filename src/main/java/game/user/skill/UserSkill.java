...
public class UserSkill {
  ...
  public void onSkillUseRequest(InPacket packet) {
    ...
    if (slv <= 0
        || SkillInfo.getInstance().getSkillLevel(user.getCharacter(), skillID, skillEntry) < slv
  ...
  public void doActiveSkill_PartyStatChange(SkillEntry skill, byte slv, InPacket packet) {
    ...
    if (skill.getLevelData(slv).getHP() != 0) {
      ...
      int rate =
          user.getSecondaryStat().mad
              + user.getSecondaryStat().getStatOption(CharacterTemporaryStat.MAD);
      rate =
          (int)
              (((double) rand * 1.5d + (double) user.getBasicStat().getLUK())
                  * (double) rate
                  * 0.01d);
      hpRate =
          (int)
              ((double) rate
                  * ((double) partyCount * 0.3d + 1.0d)
                  * (double) skill.getLevelData(slv).getHP()
                  * 0.01d);
    }
  ...
  public void doActiveSkill_MobStatChange(
      SkillEntry skill, byte slv, InPacket packet, boolean sendResult) {
  ...
  public void doActiveSkill_WeaponBooster(SkillEntry skill, byte slv, int wt1, int wt2) {
    ...
    int wt =
        ItemAccessor.getWeaponType(
            user.getCharacter().getItem(ItemType.Equip, -BodyPart.Weapon).getItemID());
    if (wt > 0
        && SkillAccessor.isCorrectItemForBooster(
            wt, user.getCharacter().getCharacterStat().getJob())
        && levelData.getTime() > 0) {
      long duration = System.currentTimeMillis() + 1000 * levelData.getTime();
      user.getSecondaryStat()
          .setStat(
              CharacterTemporaryStat.Booster,
              new SecondaryStatOption(1, skill.getSkillID(), duration));
      user.sendCharacterStat(Request.Excl, 0);
      ...
      flag |=
          user.getSecondaryStat()
              .setStat(
                  ...
                  new SecondaryStatOption(level.getPAD(), skill.getSkillID(), duration));
    }
    if (level.getPDD() != 0) {
      flag |=
          user.getSecondaryStat()
              .setStat(
                  ...
                  new SecondaryStatOption(level.getPDD(), skill.getSkillID(), duration));
    }
    if (level.getMAD() != 0) {
      flag |=
          user.getSecondaryStat()
              .setStat(
                  ...
                  new SecondaryStatOption(level.getMAD(), skill.getSkillID(), duration));
    }
    if (level.getMDD() != 0) {
      flag |=
          user.getSecondaryStat()
              .setStat(
                  ...
                  new SecondaryStatOption(level.getMDD(), skill.getSkillID(), duration));
    }
    if (level.getACC() != 0) {
      flag |=
          user.getSecondaryStat()
              .setStat(
                  ...
                  new SecondaryStatOption(level.getACC(), skill.getSkillID(), duration));
    }
    if (level.getEVA() != 0) {
      flag |=
          user.getSecondaryStat()
              .setStat(
                  ...
                  new SecondaryStatOption(level.getEVA(), skill.getSkillID(), duration));
    }
    if (level.getSpeed() != 0) {
      flag |=
          user.getSecondaryStat()
              .setStat(
                  ...
                  new SecondaryStatOption(level.getSpeed(), skill.getSkillID(), duration));
    }
    if (level.getJump() != 0) {
      flag |=
          user.getSecondaryStat()
              .setStat(
                  ...
                  new SecondaryStatOption(level.getJump(), skill.getSkillID(), duration));
    }
        ...
        flag |=
            user.getSecondaryStat()
                .setStat(
                    ...
                    new SecondaryStatOption(level.getX(), skill.getSkillID(), duration));
        break;
        ...
        flag |=
            user.getSecondaryStat()
                .setStat(
                    ...
                    new SecondaryStatOption(level.getY(), skill.getSkillID(), duration));
        break;
        // MAGICIAN
