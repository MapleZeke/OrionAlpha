...
public class SkillLevelData {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof SkillLevelData)) return false;
    ...
    if (eva != other.eva) return false;
    if (hp != other.hp) return false;
    if (hpCon != other.hpCon) return false;
    if (jump != other.jump) return false;
    if (lt == null) {
      if (other.lt != null) return false;
    } else if (!lt.equals(other.lt)) return false;
    if (mad != other.mad) return false;
    if (mastery != other.mastery) return false;
    if (mdd != other.mdd) return false;
    if (mp != other.mp) return false;
    if (mpCon != other.mpCon) return false;
    if (pad != other.pad) return false;
    if (pdd != other.pdd) return false;
    if (prop != other.prop) return false;
    if (range != other.range) return false;
    if (rt == null) {
      if (other.rt != null) return false;
    } else if (!rt.equals(other.rt)) return false;
