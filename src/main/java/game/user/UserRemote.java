...
public class UserRemote {
  ...
  /**
   * The (remote) user effect packet. This sends both skill and level-up effects of a user to the
   * field.
   *
  ...
  /**
   * The character buff packet. This will give a user a set of buffs based on the flag.
   *
  ...
  /**
   * The buff reset packet. This will cancel a set of buffs for the character based on the flag.
   *
  ...
  /**
   * The character emotion packet. Displays a character using an emotion to the field.
   *
  ...
  /**
   * The character movement packet. Displays a user moving around to the field.
   *
  ...
  /**
   * The user damaged packet. When a user is hit or takes damage, this displays the damage dealt.
   *
  ...
  /**
   * The avatar modification packet. This displays changes in a user's avatar to the field.
   *
