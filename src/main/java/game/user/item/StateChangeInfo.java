...
public class StateChangeInfo {
  ...
  public int apply(
    ...
    if ((flag & CharacterStatType.HP) != 0) {
      ...
      int inc =
          Math.min(
              Math.max(0, (int) ((double) cd.getCharacterStat().getHP() + hpInc)), bs.getMHP());
    ...
    if ((flag & CharacterStatType.MP) != 0) {
      ...
      int inc =
          Math.min(
              Math.max(0, (int) ((double) cd.getCharacterStat().getMP() + mpInc)), bs.getMMP());
    ...
    if ((flagTemp & CharacterTemporaryStat.PAD) != 0) {
      ...
      if (!applyBetterOnly
          || (pad <= 0)
          || (padOption <= pad)
              && (padOption != pad || ss.getStatDuration(CharacterTemporaryStat.PAD) <= duration)) {
        tempSet |=
            ss.setStat(CharacterTemporaryStat.PAD, new SecondaryStatOption(pad, -itemID, duration));
      }
    }
    if ((flagTemp & CharacterTemporaryStat.PDD) != 0) {
      ...
      if (!applyBetterOnly
          || (pdd <= 0)
          || (padOption <= pdd)
              && (padOption != pdd || ss.getStatDuration(CharacterTemporaryStat.PDD) <= duration)) {
        tempSet |=
            ss.setStat(CharacterTemporaryStat.PDD, new SecondaryStatOption(pdd, -itemID, duration));
      }
    }
    if ((flagTemp & CharacterTemporaryStat.MAD) != 0) {
      ...
      if (!applyBetterOnly
          || (mad <= 0)
          || (padOption <= mad)
              && (padOption != mad || ss.getStatDuration(CharacterTemporaryStat.MAD) <= duration)) {
        tempSet |=
            ss.setStat(CharacterTemporaryStat.MAD, new SecondaryStatOption(mad, -itemID, duration));
      }
    }
    if ((flagTemp & CharacterTemporaryStat.ACC) != 0) {
      ...
      if (!applyBetterOnly
          || (acc <= 0)
          || (padOption <= acc)
              && (padOption != acc || ss.getStatDuration(CharacterTemporaryStat.ACC) <= duration)) {
        tempSet |=
            ss.setStat(CharacterTemporaryStat.ACC, new SecondaryStatOption(acc, -itemID, duration));
      }
    }
    if ((flagTemp & CharacterTemporaryStat.EVA) != 0) {
      ...
      if (!applyBetterOnly
          || (eva <= 0)
          || (padOption <= eva)
              && (padOption != eva || ss.getStatDuration(CharacterTemporaryStat.EVA) <= duration)) {
        tempSet |=
            ss.setStat(CharacterTemporaryStat.EVA, new SecondaryStatOption(eva, -itemID, duration));
      }
    }
    if ((flagTemp & CharacterTemporaryStat.Speed) != 0) {
      ...
      if (!applyBetterOnly
          ...
          || (padOption <= speed)
              && (padOption != speed
                  || ss.getStatDuration(CharacterTemporaryStat.Speed) <= duration)) {
        tempSet |=
            ss.setStat(
                CharacterTemporaryStat.Speed, new SecondaryStatOption(speed, -itemID, duration));
      }
    }
