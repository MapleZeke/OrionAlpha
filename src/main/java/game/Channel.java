...
public class Channel {
  ...
  public final synchronized User findUser(int characterID) {
    lockUser.lock();
    try {
  ...
  public final synchronized User findUserByName(String name, boolean makeLower) {
    lockUser.lock();
    try {
      if (makeLower) name = name.toLowerCase();
  ...
  public final synchronized boolean registerUser(User user) {
    lockUser.lock();
    try {
