...
public class ScriptMan {
  ...
  public static OutPacket onSay(
      byte speakerTypeID, int speakerTemplateID, String text, boolean prev, boolean next) {
  ...
  public static OutPacket onAskText(
      byte speakerTypeID,
  ...
  public static OutPacket onAskNumber(
      byte speakerTypeID, int speakerTemplateID, String msg, int def, int min, int max) {
    OutPacket packet = new OutPacket(LoopbackPacket.ScriptMessage);
    packet.encodeByte(speakerTypeID);
    packet.encodeInt(speakerTemplateID);
  ...
  public static OutPacket onAskAvatar(
      byte speakerTypeID, int speakerTemplateID, String msg, int[] canadite) {
    OutPacket packet = new OutPacket(LoopbackPacket.ScriptMessage);
    packet.encodeByte(speakerTypeID);
    packet.encodeInt(speakerTemplateID);
