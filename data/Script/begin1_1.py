...
if sel == 0:
	self.sayNext("Hello! You must be new! Your name is " + self.userGetCharacterName() + "? You might feel a little weird stepping into Maple World, but don't worry about a thing! Maple World welcomes you with open arms.")
