...
if self.QuestRecordGetState(6141) == 1:
    nRet = self.askYesNo("Would you like to go to the training ground?")
    if nRet == 0:
        self.say("Let me know when you want to enter.")
    else:
        self.say("Training ground entry not implemented yet.")
else:
    val = self.QuestRecordGet(7500)
    cJob = self.UserGetJob()
    
    if self.UserGetLevel() >= 200:
        if self.UserGetJob() >= 400 and self.UserGetJob() < 500:
            info = self.QuestRecordGet(7530)
            if info == "":
                rank = self.UserGetRanking()
                if rank > 0 and rank <= 20:
                    self.say("Level 200 advancement not implemented yet.")
    elif val == "s" and (cJob == 410 or cJob == 420 or cJob == 432):
        ...
        if self.InventoryGetItemCount(4031059) >= 1:
            ...
            if not ret:
                self.say("Hmm... how strange. Are you sure that you have #b#t4031059##k? If so, make sure you have a free slot in your inventory.")
            else:
                self.QuestRecordSet(7500, "p2")
        else:
        ...
        if self.InventoryGetItemCount(4031057) <= 0:
            ...
            if not ret:
                self.say("Hmm... how strange. Make sure you have a free slot in your inventory.")
        else:
        ...
        if cJob == 400:
            if self.UserGetLevel() >= 30:
                if self.InventoryGetItemCount(4031011) >= 1:
                    self.say("Still haven't met the person yet? Find #b#p1072003##k who's around #b#m102040000##k near Kerning City. Give the letter to him and he may let you know what to do.")
                    ...
                    if nSel == 0:
                        ...
                        nSel2 = self.askMenu("Hmmm, have you made up your mind? Then choose the 2nd job advancement of your liking.\r\n#L0##bAssassin#k#l\r\n#L1##bBandit#k#l\r\n")
                        if nSel2 == 0:
                            nRet = self.askYesNo("So you want to make the 2nd job advancement as the #bAssassin#k? Once you have made the decision, you can't go back and change your mind. You ARE sure about this, right?")
                            if nRet == 0:
                                self.sayNext("Really? Have to give more thought to it, huh? Take your time, take your time. This is not something you should take lightly ... come talk to me once you have made your decision.")
                            elif nRet == 1:
                                ...
                                if self.UserGetSP() > nPSP:
                                    ...
                                    self.sayNext("Hmmmm... are you sure you have #b#t4031012##k from #p1072003#? It's better to be sure... because you can't job advance without it....")
                                else:
                                    self.UserJob(410)
                                    self.UserIncSP(1, False)
                                    incval1 = random.randint(300, 350)
                                    incval2 = random.randint(150, 200)
                            ...
                            nRet = self.askYesNo("So you want to make the 2nd job advancement as the #bBandit#k? Once you have made the decision, you can't go back and change your mind. You ARE sure about this, right?")
                            if nRet == 0:
                                self.sayNext("Really? Have to give more thought to it, huh? Take your time, take your time. This is not something you should take lightly ... come talk to me once you have made your decision.")
                            elif nRet == 1:
                                nPSP = (self.UserGetLevel() - 30) * 3
                                if self.UserGetSP() > nPSP:
                                    ...
                                    self.sayNext("I have just given you a book that gives you the the list of skills you can acquire as a bandit. I have also added a whole row to your use inventory, along with boosting up your max HP and MP...go see for it yourself.")
                                    self.sayNext("I have also given you a little bit of #bSP#k. Open the #bSkill Menu#k located at the bottomleft corner. You'll be able to boost up the newly-acquired 2nd level skills. A word of warning though: You can't boost them up all at once. Some of the skills are only available after you have learned other skills. Make sure to remember that.")
                                    self.sayNext("Bandits have to be strong. But remember that you can't abuse that power and use it on a weakling. Please use your enormous power the right way, because...for you to use that the right way, that is much harder than just getting stronger. Find me after you have advanced much further.")
                else:
                    nRet = self.askYesNo("Hmmm...you seem to have gotten a whole lot stronger. You got rid of the old, weak self and and look much more like a thief now. Well, what do you think? Don't you want to get even more powerful than that? Pass a simple test and I'll do just that for you. Do you want to do it?")
                    if nRet == 0:
                        self.say("Really? It will help you out a great deal on your journey if you get stronger fast...if you choose to change your mind in the future, please feel free to come back. Know that I'll make you much more powerful than you are right now.")
                    elif nRet == 1:
                        ...
                        ret = self.InventoryExchange(0, 4031011, 1)
                        if not ret:
                            ...
                            self.say("Please take this letter to #b#p1072003##k around #b#m102040000##k near Kerning City. He's doing the job of an instructor in place of me. Give him the letter and he'll give you the test for me. If you want more details, hear it straight from him. I'll be wishing you good luck.")
            else:
                v = self.askMenu("Do you have anything you want to know about thieves?\r\n#L0##bWhat are the basic characters of a Thief?#k#l\r\n#L1##bWhat are the weapons that the Thieves use?#k#l\r\n#L2##bWhat are the armors that the Thieves use?#k#l\r\n#L3##bWhat are the skills available for Thieves?#k#l")
                if v == 0:
            ...
            if self.UserGetLevel() > 9:
                nRet = self.askYesNo("Oh...! You look like someone that can definitely be a part of us...all you need is a little sinister mind, and...yeah...so, what do you think? Wanna be the Thief?")
                if nRet == 0:
                    self.sayNext("Really? Have to give more thought to it, huh? Take your time, take your time. This is not something you should take lightly...come talk to me once you have made your decision.")
                elif nRet == 1:
                    if self.InventoryGetSlotCount(1) > self.InventoryGetHoldCount(1) + 1 and self.InventoryGetSlotCount(2) > self.InventoryGetHoldCount(2) + 2:
                        ...
                        ret = self.InventoryExchange(0, 1472061, 1, 1332063, 1, 2070015, 1000, 2070015, 1000, 2070015, 1000)
                        if not ret:
                            self.sayNext("Hmmm. Make sure you have a free slot in your inventory tab Equip. I would like to give you a weapon since you job advanced.")
                        else:
                            self.UserJob(400)
                            self.UserIncSP(1, False)
                            if self.UserGetLevel() >= 30:
                            ...
                            valh = random.randint(100, 150)
                            valm = random.randint(30, 50)
                ...
                self.sayNext("You need to train more. Don't think being a Thief is a walk in the park...")
        elif cJob == 410:
            self.say("Ahhh... It's you! What do you think? How's it to be an Assassin? You... look stronger! I hope you keep training.")
        elif cJob == 420:
            self.say("Ahhh... It's you! What do you think? How's it to be a Bandit? You... look stronger! I hope you keep training!")
        elif cJob == 411:
            self.say("Ahhh... You finally became a #bHermit#k... I knew you wouldn't let me down. So, how does it feel to be a Hermit? Please, keep up the work and keep training.")
        elif cJob == 421:
            self.say("Ahhh... You finally became a #bChief Bandit#k... I knew you wouldn't let me down. So, how does it feel to be a Chief Bandit? Please, keep up the work and keep training.")
        elif cJob == 412:
            self.say("Ahhh... You finally became a #bNight Lord#k... I knew you wouldn't let me down. So, how does it feel to be a Night Lord? Please, keep up the work and keep training.")
        elif cJob == 422:
            self.say("Ahhh... You finally became a #bShadower#k... I knew you wouldn't let me down. So, how does it feel to be a Shadower? Please, keep up the work and keep training.")
        else:
            self.say("Exploring is good, and getting stronger is good and all... but don't you want to enjoy living the life as you know it? How about becoming a Thief like us and really LIVE the life? Sounds fun, isn't it?")
