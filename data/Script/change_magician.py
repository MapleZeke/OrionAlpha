...
if self.userGetJob() == 200 and self.userGetLevel() >= 30:
    ...
    if self.inventoryGetItemCount(4031009) >= 1:
        if nBlack == 0:
            ...
            if nRet == 0:
                self.sayNext("I don't think you are prepared for this. Talk to me when you make yourself much more ready for this. There are neither portals nor stores inside, so you better get ready for it all the way.")
            elif nRet == 1:
                ...
                aMap = [108000200, 108000201, 108000202]
...
elif self.userGetJob() == 200 and self.userGetLevel() < 30:
    self.sayNext("Do you want to be an even stronger magician? Let me take care of that. However... you look pretty weak. Train more, get stronger, and then come back here.")
elif self.userGetJob() == 210 or self.userGetJob() == 220 or self.userGetJob() == 230:
    self.sayNext("Hmmm... it was you who passed my test! What do you think? Do you feel more powerful than before? Good! You now definitely have the look of a magician...")
