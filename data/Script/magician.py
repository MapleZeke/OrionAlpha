...
if self.UserGetLevel() >= 200:
    if self.UserGetJob() >= 200 and self.UserGetJob() < 300:
...
elif val == "s" and (cJob == 210 or cJob == 220 or cJob == 230):
    ...
    if self.InventoryGetItemCount(4031059) >= 1:
        ...
        if not ret:
            self.say("Hmm... how strange. Are you sure that you have #b#t4031059##k? If yes, make sure you have a free slot in your inventory.")
        else:
    ...
    if cJob == 200:
        if self.UserGetLevel() >= 30:
            if self.InventoryGetItemCount(4031009) >= 1:
                self.say("Still haven't met the person yet? Find #b#p1072001##k who's around #b#m101020000##k near Ellinia. Give the letter to him and he may let you know what to do.")
                ...
                if nSel == 0:
                    ...
                    nSel2 = self.askMenu("Now, have you made up your mind? Please select your occupation for the 2nd job advancement.\r\n#L0##bThe Wizard of Fire and Poison#l#k\r\n#L1##bThe Wizard of Ice and Lightning#l#k\r\n#L2##bCleric#l#k\r\n")
                    if nSel2 == 0:
                        nRet = self.askYesNo("So you want to make the 2nd job advancement as the #bWizard of Fire and Poison#k? Once you have made your decision, you can't go back and change your job anymore. Are you sure about the decision?")
                        if nRet == 0:
                            ...
                            if self.UserGetSP() > nPSP:
                                ...
                                self.sayNext("Hmmmm... are you sure you have #b#t4031012##k from #p1072001#? It's better to be sure... because you can't job advance without it....")
                            else:
                                self.UserJob(210)
                                self.UserIncSP(1, False)
                                incval = random.randint(450, 500)
                        ...
                        nRet = self.askYesNo("So you want to make the 2nd job advancement as the #bWizard of Ice and Lightning#k? Once you have made your decision, you can't go back and change your job anymore. Are you sure about the decision?")
                        if nRet == 0:
                            self.sayNext("Really? Have to give more thought to it, huh? Take your time, take your time. This is not something you should take lightly ... come talk to me once you have made your decision.")
                        elif nRet == 1:
                            nPSP = (self.UserGetLevel() - 30) * 3
                        ...
                        nRet = self.askYesNo("So you want to make the 2nd job advancement as the #bCleric#k? Once you have made your decision, you can't go back and change your job anymore. Are you sure about the decision?")
                        if nRet == 0:
                            self.sayNext("Really? Have to give more thought to it, huh? Take your time, take your time. This is not something you should take lightly ... come talk to me once you have made your decision.")
                        elif nRet == 1:
                            nPSP = (self.UserGetLevel() - 30) * 3
                ...
                if nRet == 0:
                    ...
                    ret = self.InventoryExchange(0, 4031009, 1)
                    if not ret:
                        ...
                        self.say("Please get this letter to #b#p1072001##k around #b#m101020000##k near Ellinia. He's doing the role of an instructor in place of me. He'll give you all the details about it. Best of luck to you...")
        else:
            v = self.askMenu("Any questions about being a Magician?\r\n#L0##bWhat are the basic characteristics of being a Magician?#k#l\r\n#L1##bWhat are the weapons that the Magicians use?#k#l\r\n#L2##bWhat are the armors the Magicians can wear?#k#l\r\n#L3##bWhat are the skills available for Magicians?#k#l")
            if v == 0:
        ...
        if self.UserGetLevel() > 7:
            ...
            if nRet == 0:
                self.sayNext("Really? Have to give more thought to it, huh? Take your time, take your time. This is not something you should take lightly...come talk to me once your have made your decision...")
            elif nRet == 1:
                if self.InventoryGetSlotCount(1) > self.InventoryGetHoldCount(1):
                    ...
                    ret = self.InventoryExchange(0, 1372043, 1)
                    if not ret:
                        ...
                        if self.UserGetLevel() >= 30:
                            ...
                            nPSP = (self.UserGetLevel() - 8) * 3
                            self.UserIncSP(nPSP, False)
                        incval = random.randint(100, 150)
                        self.UserIncMMP(incval, False)
        ...
        self.say("Ahhh... you are... how do you like being a Wizard? You... you seem used to these fire arrows now... please, work hard and train more.")
    elif cJob == 220:
        self.say("Ahhh... you are... how do you like being a Wizard? You... you seem used to ice and light now... please, work hard and train more.")
    elif cJob == 230:
        self.say("Ahhh... you are... how do you like being a Cleric? You... you seem used to holy magic now... please, work hard and train more.")
    elif cJob == 211 or cJob == 221:
        self.say("Ahhh... You finally became a #bMage#k... I knew you wouldn't let me down. How does it feel to be a Mage? Please, work hard and train more.")
    elif cJob == 231:
        self.say("Ahhh... You finally became a #bPriest#k... I knew you wouldn't let me down. How does it feel to be a Priest? Please, work hard and train more.")
    else:
