    ...
    if self.inventoryGetItemCount(4031011) >= 1:
        if nBlack == 0:
            ...
            if nRet == 0:
                ...
                aMap = [108000400, 108000401, 108000402]
...
elif self.userGetJob() == 400 and self.userGetLevel() < 30:
    self.sayNext("You really want to become a better thief? Let me take care of it. However, you seem very weak. Train and get stronger and then come back here.")
elif self.userGetJob() == 410 or self.userGetJob() == 420 or self.userGetJob() == 430:
    self.sayNext("Hmmm... it was you who took on my test!! What do you think? Have you become stronger since then?? Good! Now I can definitely see your strength as a rogue.")
