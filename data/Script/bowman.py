...
if self.UserGetLevel() >= 200:
    if self.UserGetJob() >= 300 and self.UserGetJob() < 400:
...
elif val == "s" and (cJob == 310 or cJob == 320):
    ...
    if self.InventoryGetItemCount(4031057) <= 0:
        ...
        self.say("Deliver this necklace to #bRene#k of Ossyria and you'll be able to do the second quest for job advancement. Good luck~.")
else:
    if cJob == 300:
        if self.UserGetLevel() >= 30:
            if self.InventoryGetItemCount(4031010) >= 1:
                self.say("Still haven't met the person yet? Find #b#p1072002##k who's around #b#m106010000##k near Henesys. Give the letter to her and she may let you know what to do.")
            elif self.InventoryGetItemCount(4031012) >= 1:
                self.sayNext("Hmmm...so you got back here safely. I knew that test would be too easy for you. I admit, you are a great bowman. Now...I'll make you even more powerful than you already are. But, before all that...you need to choose one of two ways. It'll be a difficult decision for you to make, but...if you have any questions, please ask.")
                ...
                if nSel == 0:
                    ...
                    if nSel2 == 0:
                        nRet = self.askYesNo("So you want to make the second job advancement as the #bHunter#k? You know you won't be able to choose a different job for the second job advancement once you make your decision here, right?")
                        if nRet == 0:
                            ...
                            if self.UserGetSP() > nPSP:
                                ...
                                self.sayNext("Hmmmm... are you sure you have #b#t4031012##k from #p1072002#? It's better to be sure... because you can't job advance without it....")
                            else:
                                self.UserJob(310)
                        ...
                        nRet = self.askYesNo("So you want to make the second job advancement as the #bCrossbowman#k? You know you won't be able to choose a different job for the second job advancement once you make your decision here, right?")
                        if nRet == 0:
                            self.sayNext("Really? Have to give more thought to it, huh? Take your time, take your time. This is not something you should take lightly ... come talk to me once you have made your decision.")
                        elif nRet == 1:
                            nPSP = (self.UserGetLevel() - 30) * 3
                            if self.UserGetSP() > nPSP:
                                ...
                                self.sayNext("I have just given you a book that gives you the the list of skills you can acquire as a crossbowman. Also your etc. inventory has expanded by adding another row to it. Your max HP and MP have also increased, too. Go check and see for it yourself.")
                                self.sayNext("I have also given you a little bit of #bSP#k. Open the #bSkill Menu#k located at the bottomleft corner. You'll be able to boost up the newly-acquired 2nd level skills. A word of warning though: You can't boost them up all at once. Some of the skills are only available after you have learned other skills. Make sure to remember that.")
                ...
                nRet = self.askYesNo("Hmmm...you have grown a lot since I last saw you. I don't see the weakling I saw before, and instead, look much more like a bowman now. Well, what do you think? Don't you want to get even more powerful than that? Pass a simple test and I'll do just that for you. Do you want to do it?")
                if nRet == 0:
                    self.say("Really? Have to give it more thought, huh? Take your time, take your time. This is not something you should take lightly...come talk to me once you have made your decision.")
                elif nRet == 1:
                    ...
                    ret = self.InventoryExchange(0, 4031010, 1)
                    if not ret:
                        ...
                        self.say("Please get this letter to #b#p1072002##k who's around #b#m106010000##k near Henesys. She's taking care of the the job of an instructor in place of me. Give her the letter and she'll test you in place of me. Best of luck to you.")
        else:
            v = self.askMenu("Do you have any questions regarding the life of the Bowman?\r\n#L0##bWhat are the basic characters of a Bowman?#k#l\r\n#L1##bWhat are the weapons that the Bowman use?#k#l\r\n#L2##bWhat are the armors that the bowman can wear?#k#l\r\n#L3##bWhat are the skills of the Bowman?#k#l")
            if v == 0:
        ...
        self.sayNext("So you want to become the Bowman??? Well...you need to meet some requirements to do so...at least #bLevel 10#k. Let's see...hmm...")
        if self.UserGetLevel() > 9:
            nRet = self.askYesNo("You look qualified for this. With a great pair of eyes being able to spot the real monsters and have the coldhearted skills to shoot the arrow through them...we needed someone like that. Do you want to become a Bowman?")
            if nRet == 0:
                self.sayNext("Really? Have to give more though to it, huh? Take your time, take your time. This is not something you should take lightly...come talk to me once you have made your decision.")
            elif nRet == 1:
                if self.InventoryGetSlotCount(1) > self.InventoryGetHoldCount(1) and self.InventoryGetSlotCount(2) > self.InventoryGetHoldCount(2) + 2:
                    ...
                    ret = self.InventoryExchange(0, 1452051, 1, 2060000, 2000, 2060000, 2000, 2060000, 2000)
                    if not ret:
        ...
        self.say("Ahhh... It's you! What do you think? How's it to be a Hunter? You... look stronger! I hope you keep training.")
    elif cJob == 320:
        self.say("Ahhh... It's you! What do you think? How's it to be a Crossbowman? You... look stronger! I hope you keep training!")
    elif cJob == 311:
        self.say("Ahhh... You finally became a #bRanger#k... I knew you wouldn't let me down. So, how does it feel to be a Ranger? Please, keep up the work and keep training.")
    elif cJob == 321:
        self.say("Ahhh... You finally became a #bSniper#k... I knew you wouldn't let me down. So, how does it feel to be a Sniper? Please, keep up the work and keep training.")
    elif cJob == 312:
        self.say("Ahhh... You finally became a #bBowmaster#k... I knew you wouldn't let me down. So, how does it feel to be a Bowmaster? Please, keep up the work and keep training.")
    elif cJob == 322:
        self.say("Ahhh... You finally became a #bMarksman#k... I knew you wouldn't let me down. So, how does it feel to be a Marksman? Please, keep up the work and keep training.")
    else:
