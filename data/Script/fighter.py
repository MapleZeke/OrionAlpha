...
if self.UserGetLevel() >= 200:
    if self.UserGetJob() >= 100 and self.UserGetJob() < 200:
...
elif val == "s" and (cJob == 110 or cJob == 120 or cJob == 130):
    ...
    if cJob == 100:
        if self.UserGetLevel() >= 30:
            if self.InventoryGetItemCount(4031008) >= 1:
                self.say("Still haven't found the person? Find #b#p1072000##k which is near #b#m102020300##k next to #m102000000#. Deliver the letter to him and maybe he'll tell you what to do.")
                    ...
                    if nSel2 == 0:
                        ...
                        if nRet == 0:
                            ...
                            if self.UserGetSP() > nPSP:
                                ...
                                self.sayNext("Hmmmm... Are you sure you have #b#t4031012##k from #p1072000#? It's better to be sure, because I can't allow you to advance classes without it.")
                            else:
                                self.UserJob(110)
                                self.UserIncSP(1, False)
                                incval = random.randint(300, 350)
                        ...
                        if nRet == 0:
                            self.sayNext("Really? You need to think better, right? No need to hurry. It's not something to be done half heartedly... come talk to me when you have made your decision, okay?")
                        elif nRet == 1:
                            nPSP = (self.UserGetLevel() - 30) * 3
                            if self.UserGetSP() > nPSP:
                                self.sayNext("Hmmm...you have too much SP...you can't make the 2nd job advancement with that many SP in store. Use more SP on the skills on the 1st level and then come back.")
                        ...
                        if nRet == 0:
                            self.sayNext("Really? You need to think more about it? No need to hurry. It's not something to be done half heartedly... come talk to me when you have made your decision, okay?")
                        elif nRet == 1:
                            nPSP = (self.UserGetLevel() - 30) * 3
                            if self.UserGetSP() > nPSP:
                                self.sayNext("Hmmm...you have too much SP...you can't make the 2nd job advancement with that many SP in store. Use more SP on the skills on the 1st level and then come back.")
                ...
                if nRet == 0:
                    ...
                    if not ret:
                        ...
                        self.say("Give this letter to #b#p1072000##k which can be near #b#m102020300##k next to #m102000000#. He's subbing me as an instrutor, because I'm busy here. Give him the letter and he'll give you the test in my place. Other information will be given by him. Good luck.")
        else:
        ...
        if self.UserGetLevel() > 9:
            ...
            if nRet == 0:
                ...
                if self.InventoryGetSlotCount(1) > self.InventoryGetHoldCount(1):
                    ...
                    ret = self.InventoryExchange(0, 1302077, 1)
                    if not ret:
        ...
        self.say("Ahhh... You finally became a #bCrusader#k... I knew I wouldn't be let down. So, how does it feel to be a Crusader? Please, keep up the work and keep training.")
    elif cJob == 121:
        self.say("Ahhh... You finally became a #bWhite Knight#k... I knew I wouldn't be let down. So, how does it feel to be a White Knight? Please, keep up the work and keep training.")
    elif cJob == 131:
        self.say("Ahhh... You finally became a #bDragon Knight#k... I knew I wouldn't be let down. So, how does it feel to be a Dragon Knight? Please, keep up the work and keep training.")
    elif cJob == 112:
        self.say("Ahhh... You finally became a #bHero#k... I knew I wouldn't be let down. So, how does it feel to be a Hero? Please, keep up the work and keep training.")
    elif cJob == 122:
        self.say("Ahhh... You finally became a #bPaladin#k... I knew I wouldn't be let down. So, how does it feel to be a Paladin? Please, keep up the work and keep training.")
    elif cJob == 132:
        self.say("Ahhh... You finally became a #bDark Knight#k... I knew I wouldn't be let down. So, how does it feel to be a Dark Knight? Please, keep up the work and keep training.")
    else:
